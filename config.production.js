/**
 * Production Configuration for Cloudflare Deployment
 * This file contains the production settings for Cloudflare Workers
 */

const CONFIG = {
    // API Configuration
    API: {
        BASE_URL: 'https://oecd-edt-elvis-campbell.trycloudflare.com', // Cloudflare tunnel URL
        ENDPOINTS: {
            // Health and Status
            HEALTH: '/health',
            STATUS: '/api/status',
